...
%\begin{figure}[H]
%  \centering
%  \includegraphics[width=0.7\linewidth]{bruteforce.png}
%  \caption{総当たり法における探索のイメージ}
%  \label{fig:bruteforce}
%\end{figure}

%図\ref{fig:bruteforce}のように、各品物について入れるか入れないかを分岐させ、すべての組み合わせを調べる。
...
%\begin{figure}[H]
%  \centering
%  \includegraphics[width=0.7\linewidth]{dp_image.png}
%  \caption{動的計画法における更新のイメージ}
%  \label{fig:dp}
%\end{figure}

%図\ref{fig:dp}のように、現在の品物を入れる場合は、その品物の重さを引いた残り容量における最大価値を利用する。
...
%表\ref{tab:comparison}より、品物数が増えるほど総当たり法は急激に計算量が増えることが分かる。これに対して動的計画法は、重さの上限が大きすぎなければ効率よく解を求めることができる。
